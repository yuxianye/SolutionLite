...
--看板管理															 
INSERT INTO [dbo].[Module]([Id],[Name],[ShowInNavigateMenu],[ParentId],[OrderCode],[Icon],[AssemblyName],[ViewName],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES('03000000-0000-0000-0000-000000000000',N'看板管理',1,N'00000000-0000-0000-0000-000000000000',3,'pack://application:,,,/Desktop.Resource;component/Images/BaseData_32.png',NULL,NULL,getdate(),'admin',getdate(),'admin',null)
INSERT INTO [dbo].[Module]([Id],[Name],[ShowInNavigateMenu],[ParentId],[OrderCode],[Icon],[AssemblyName],[ViewName],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES('03010000-0000-0000-0000-000000000000',N'3DX看板',1,N'03000000-0000-0000-0000-000000000000',3.1,'pack://application:,,,/Desktop.Resource;component/Images/Equipment_32.png','Desktop.ThreeDModule','Desktop.ThreeDModule.Views.ThreeDxView',getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'01000000-0000-0000-0000-000000000000','Channel_1.Device_1.Bool_000'+CAST(@ct as nvarchar),3,100,1,getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'02000000-0000-0000-0000-000000000000','TestChannel.TestDevice.Agv_TaskStatus'+CAST(@ct as nvarchar),3,100,3,getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000','TestChannel.TestDevice.Agv_TaskStatus'+CAST(@ct as nvarchar),3,100,1,getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000',N'ns=2;s=数据类型示例.8 位设备.R 寄存器.Boolean1',3,100,1,getdate(),'admin',getdate(),'admin',null)
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000',N'ns=2;s=数据类型示例.8 位设备.R 寄存器.Boolean2',3,100,1,getdate(),'admin',getdate(),'admin',null)
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000',N'ns=2;s=数据类型示例.8 位设备.R 寄存器.Boolean3',3,100,1,getdate(),'admin',getdate(),'admin',null)
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000',N'ns=2;s=数据类型示例.8 位设备.R 寄存器.Boolean4',3,100,1,getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'03000000-0000-0000-0000-000000000000','Channel_1.Device_1.Bool_0001',3,100,1,getdate(),'admin',getdate(),'admin',null)
...
INSERT INTO [dbo].[DeviceNode]([Id],[OpcServerId],[Name],[DataType],[UpdateRate],[IsEnable],[CreatedTime],[CreatorUser],[LastUpdatedTime],[LastUpdatorUser],[Remark])VALUES(NEWID(),'02000000-0000-0000-0000-000000000000','Channel_1.Device_1.Bool_0002',3,100,1,getdate(),'admin',getdate(),'admin',null)
