...
namespace Desktop.NoticeModule.ViewModels
{
    ...
    /// 新建通知VM
    /// </summary>
    public class NoticeAddViewModel : Desktop.Core.ViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        #region 当前的数据模型
        private Notice currentDataModel = new Notice();
        /// <summary>
        /// 当前的数据模型
        /// </summary>
        ...
        private async void executeConfirmCommand()
        {
            ...
            try
            {
                ...
                if (dbContext.NoticeDb.Insert(CurrentDataModel))
                {
                    UiMessage = "新建成功";
