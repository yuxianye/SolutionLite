...
namespace Utility
{
    ...
    public static class TypeExtensions
    {
        ...
        /// </summary>
        public static string[] GetBrowseNames(this Type type)
        {
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public static string GetPropertiesValue<T>(T t)
        {
        ...
        /// TypeCodeToTypeDic
        /// </summary>
        public static IReadOnlyDictionary<TypeCode, Type> TypeCodeToTypeDic = new Dictionary<TypeCode, Type>
        {
        ...
        /// <summary>
        ///  <seealso cref="TypeCode"/>转<seealso cref="Type"/>
        /// </summary>
        public static Type ToType(this TypeCode code)
        {
            Type type = null;
            TypeCodeToTypeDic.TryGetValue(code, out type);
            return type;
        }
    }
}
