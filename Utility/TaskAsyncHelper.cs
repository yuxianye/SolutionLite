...
namespace Utility
{
    ...
    public static class TaskAsyncHelper
    {
        ...
        public static async void RunAsync<Tin, TResult>(Func<Tin, TResult> function, Action<TResult, Exception> callback,
          Tin inParamForFunction)
        {
            var exception = default(Exception);
            var rlt = default(TResult);
            try
            {
                Func<Tin, Task<TResult>> taskFunc = inObj => { return Task.Run(() => { return function(inObj); }); };
