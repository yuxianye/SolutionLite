...
namespace Desktop.VisionModule.ViewModels
{
    ...
    /// 新建VM
    /// </summary>
    public class PredictRecoredAddViewModel : Desktop.Core.ViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public PredictRecoredAddViewModel()
        {
            this.Stations = new ObservableCollection<Station>(dbContext.StationDb.GetList());
        ...
        #region 当前的数据模型
        private PredictRecored currentDataModel = new PredictRecored();
        /// <summary>
        /// 当前的数据模型
        /// </summary>
        ...
        private async void executeConfirmCommand()
        {
            ...
            try
            {
                ...
                if (dbContext.PredictRecoredDb.Insert(CurrentDataModel))
                {
                    UiMessage = "新建成功";
        ...
        {
            if (dbContext.PredictRecoredDb.IsAny(a => a.Name == CurrentDataModel.Name && a.StationId == CurrentDataModel.StationId))
            {
