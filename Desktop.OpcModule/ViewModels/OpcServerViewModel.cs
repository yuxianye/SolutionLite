...
namespace Desktop.OpcModule.ViewModels
{
    ...
    /// Opc服务管理VM
    /// </summary>
    public class OpcServerViewModel : Desktop.Core.PageableViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public OpcServerViewModel()
        {
            initCommand();
            initMenus();
            EventAggregator.GetEvent<UpListDataEvent>().Subscribe(upListData, Prism.Events.ThreadOption.BackgroundThread, false, x =>
            {
                return (x is OpcServer);
            });
        ...
        /// 新建页面的名称
        /// </summary>
        private static readonly string addViewName = "Desktop.OpcModule.Views.OpcServerAddView";
        /// <summary>
        /// 编辑页面的名称
        /// </summary>
        private static readonly string editViewName = "Desktop.OpcModule.Views.OpcServerEditView";
        /// <summary>
        /// 删除页面的名称
        /// </summary>
        private static readonly string deleteViewName = "Desktop.OpcModule.Views.OpcServerDeleteView";
        /// <summary>
        /// 导入页面的名称
        /// </summary>
        private static readonly string importViewName = "Desktop.OpcModule.Views.OpcServerImportView";
        /// <summary>
        /// 导出页面的名称
        /// </summary>
        private static readonly string exportViewName = "Desktop.OpcModule.Views.OpcServerExportView";
        /// <summary>
        /// 打印页面的名称
        /// </summary>
        private static readonly string printViewName = "Desktop.OpcModule.Views.OpcServerPrintView";

        #endregion

        #region 列表数据
        private ObservableCollection<OpcServer> dataList = new ObservableCollection<OpcServer>();

        /// <summary>
        /// 列表数据
        /// </summary>
        public ObservableCollection<OpcServer> DataList
        {
            get { return dataList; }
        ...
        #region 选中的数据
        private OpcServer selectedData;
        /// <summary>
        /// 选中的数据
        /// </summary>
        public OpcServer SelectedData
        {
        ...
        private async void executeDeleteCommand()
        {
            ...
            try
            {
                ...
                {
                    if (dbContext.OpcServerDb.DeleteById(SelectedData.Id))
                    {
                        getPageData(1, PageSize);
                        UiMessage = $"删除{SelectedData.Name}成功";
                        LogHelper.Logger.Info($"{StaticData.CurrentUser.Name }/{StaticData.CurrentUser.NickName},{UiMessage}{System.Environment.NewLine}{Utility.TypeExtensions.GetPropertiesValue<OpcServer>(SelectedData)}");
                        SelectedData = null;
                    }
                    else
                    {
            ...
            {
                string msg = $"删除OPC服务器时错误{ex.Message}";
            ...
            Task.Factory.StartNew(() =>
             {
                 try
                 {
                     Expression<Func<OpcServer, bool>> expression = null;
                     ...
                     {
                         expression = (a) => a.Name.Contains(searchText) || a.Uri.Contains(searchText) || a.CreatorUser.Contains(searchText) || a.LastUpdatorUser.Contains(searchText);
                     }
                     //根据条件查询分页数据
