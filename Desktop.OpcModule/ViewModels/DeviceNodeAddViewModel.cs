...
namespace Desktop.OpcModule.ViewModels
{
    ...
    /// 新建节点VM
    /// </summary>
    public class DeviceNodeAddViewModel : Desktop.Core.ViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public DeviceNodeAddViewModel()
        {
        ...
        #region 当前的数据模型
        private DeviceNode currentDataModel = new DeviceNode();
        /// <summary>
        /// 当前的数据模型
        /// </summary>
        ...
        private async void executeConfirmCommand()
        {
            ...
            try
            {
                ...
                if (dbContext.DeviceNodeDb.Insert(CurrentDataModel))
                {
                    UiMessage = "新建成功";
        ...
        {
            if (dbContext.DeviceNodeDb.IsAny(a => a.Name == CurrentDataModel.Name && a.OpcServerId == CurrentDataModel.OpcServerId))
            {
