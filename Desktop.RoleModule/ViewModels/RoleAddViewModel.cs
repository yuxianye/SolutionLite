...
namespace Desktop.RoleModule.ViewModels
{
    ...
    /// 新建角色VM
    /// </summary>
    public class RoleAddViewModel : Desktop.Core.ViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        private async void executeConfirmCommand()
        {
            ...
            try
            {
                ...
                if (dbContext.RoleDb.Insert(CurrentDataModel))
                {
                    var roleModule = from a in SelectedModuleList
                    ...
                    if (roleModule.Any())
                    {
                        dbContext.RoleModuleDb.InsertRange(roleModule?.ToList());
                    }
                    //提交事物
        ...
        private bool canExecuteConfirmCommand()
        {
            ...
            {
                if (dbContext.RoleDb.Count(a => a.Name == CurrentDataModel.Name) > 0)
                {
