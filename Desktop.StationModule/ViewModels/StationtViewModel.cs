...
namespace Desktop.StationModule.ViewModels
{
    ...
    /// 工位管理VM
    /// </summary>
    public class StationViewModel : Desktop.Core.PageableViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// 程序集名称
        /// </summary>
        private static readonly string assemblyName = "Desktop.StationModule";
        /// <summary>
        /// 新建页面的名称
        /// </summary>
        private static readonly string addViewName = "Desktop.StationModule.Views.StationAddView";
        /// <summary>
        /// 编辑页面的名称
        /// </summary>
        private static readonly string editViewName = "Desktop.StationModule.Views.StationEditView";
        /// <summary>
        /// 删除页面的名称
        /// </summary>
        private static readonly string deleteViewName = "Desktop.StationModule.Views.StationDeleteView";
        /// <summary>
        /// 导入页面的名称
        /// </summary>
        private static readonly string importViewName = "Desktop.StationModule.Views.StationImportView";
        /// <summary>
        /// 导出页面的名称
        /// </summary>
        private static readonly string exportViewName = "Desktop.StationModule.Views.StationExportView";
        /// <summary>
        /// 打印页面的名称
        /// </summary>
        private static readonly string printViewName = "Desktop.StationModule.Views.StationPrintView";

        #endregion

        #region 列表数据
        private ObservableCollection<Station> dataList = new ObservableCollection<Station>();

        /// <summary>
        /// 列表数据
        /// </summary>
        public ObservableCollection<Station> DataList
        {
            get { return dataList; }
        ...
        #region 选中的数据
        private Station selectedData;
        /// <summary>
        /// 选中的数据
        /// </summary>
        public Station SelectedData
        {
        ...
        private async void executeDeleteCommand()
        {
            ...
            try
            {
                ...
                {
                    if (dbContext.StationDb.DeleteById(SelectedData.Id))
                    {
                        getPageData(1, PageSize);
                        UiMessage = $"删除{SelectedData.Name}成功";
                        LogHelper.Logger.Info($"{StaticData.CurrentUser.Name }/{StaticData.CurrentUser.NickName},{UiMessage}{System.Environment.NewLine}{Utility.TypeExtensions.GetPropertiesValue<Station>(SelectedData)}");
                        SelectedData = null;
                    }
                    else
                    {
            ...
            Task.Factory.StartNew(() =>
             {
                 try
                 {
                     Expression<Func<Station, bool>> expression = null;
                     ...
                     //根据条件查询分页数据
                     DataList = new ObservableCollection<Station>(dbContext.StationDb.GetPageList(expression,
                          new PageModel() { PageIndex = pageIndex, PageSize = pageSize }, a => a.CreatedTime, OrderByType.Desc));
                     TotalCounts = dbContext.StationDb.Count(expression);
                     UiMessage = "数据加载完成";
                 }
                 catch (Exception ex)
                 {
