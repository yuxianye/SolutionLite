...
namespace Desktop.EquipmentModule.ViewModels
{
    ...
    /// 设备管理VM
    /// </summary>
    public class EquipmentViewModel : Desktop.Core.PageableViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// 程序集名称
        /// </summary>
        private static readonly string assemblyName = "Desktop.EquipmentModule";
        /// <summary>
        /// 新建页面的名称
        /// </summary>
        private static readonly string addViewName = "Desktop.EquipmentModule.Views.EquipmentAddView";
        /// <summary>
        /// 编辑页面的名称
        /// </summary>
        private static readonly string editViewName = "Desktop.EquipmentModule.Views.EquipmentEditView";
        /// <summary>
        /// 删除页面的名称
        /// </summary>
        private static readonly string deleteViewName = "Desktop.EquipmentModule.Views.EquipmentDeleteView";
        /// <summary>
        /// 导入页面的名称
        /// </summary>
        private static readonly string importViewName = "Desktop.EquipmentModule.Views.EquipmentImportView";
        /// <summary>
        /// 导出页面的名称
        /// </summary>
        private static readonly string exportViewName = "Desktop.EquipmentModule.Views.EquipmentExportView";
        /// <summary>
        /// 打印页面的名称
        /// </summary>
        private static readonly string printViewName = "Desktop.EquipmentModule.Views.EquipmentPrintView";

        #endregion

        #region 列表数据
        private ObservableCollection<Equipment> dataList = new ObservableCollection<Equipment>();

        /// <summary>
        /// 列表数据
        /// </summary>
        public ObservableCollection<Equipment> DataList
        {
            get { return dataList; }
        ...
        #region 选中的数据
        private Equipment selectedData;
        /// <summary>
        /// 选中的数据
        /// </summary>
        public Equipment SelectedData
        {
        ...
        private async void executeDeleteCommand()
        {
            ...
            try
            {
                ...
                {
                    if (dbContext.EquipmentDb.DeleteById(SelectedData.Id))
                    {
                        getPageData(1, PageSize);
                        UiMessage = $"删除{SelectedData.Name}成功";
                        LogHelper.Logger.Info($"{StaticData.CurrentUser.Name }/{StaticData.CurrentUser.NickName},{UiMessage}{System.Environment.NewLine}{Utility.TypeExtensions.GetPropertiesValue<Equipment>(SelectedData)}");
                        SelectedData = null;
                    }
                    else
                    {
            ...
            Task.Factory.StartNew(() =>
             {
                 try
                 {
                     Expression<Func<Equipment, bool>> expression = null;
                     ...
                     {
                         expression = (a) => a.Name.Contains(searchText) || a.Code.Contains(searchText) || a.CreatorUser.Contains(searchText) || a.LastUpdatorUser.Contains(searchText);
                     }
                     //根据条件查询分页数据
                     DataList = new ObservableCollection<Equipment>(dbContext.EquipmentDb.GetPageList(expression,
                          new PageModel() { PageIndex = pageIndex, PageSize = pageSize }, a => a.CreatedTime, OrderByType.Desc));
                     TotalCounts = dbContext.EquipmentDb.Count(expression);
                     UiMessage = "数据加载完成";
                 }
                 catch (Exception ex)
                 {
